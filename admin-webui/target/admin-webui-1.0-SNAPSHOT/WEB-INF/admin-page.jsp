                    ...
                    <form action="/admin/get/page.html" method="post" class="form-inline" role="form" style="float:left;">
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input class="form-control has-success" name="keyword" type="text" value="${param.keyword}" placeholder="请输入查询条件">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        var properties = {
            ...
            callback: pageselectCallback,  //点击页码时的回调函数
            prev_text:"上一页",  //显示文本
            next_text:"下一页",
            items_per_page: ${requestScope.pageInfo.pageSize },  //每页显示条数
            current_page: ${requestScope.pageInfo.pageNum - 1 }  //从0开始
        };
        // 创建分页
        $("#Pagination").pagination(totalRecord, properties);
    };

    //参数page_index{int整型}表示当前的索引页,从0开始
